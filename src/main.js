...
function init() {
    ...
    pointLight.position.set(23, 11, 18);
...
function initGUI(ambientLight, pointLight) {
    ...
    posFolder.add(sphere.position, 'x').min(-20).max(20).step(0.1).name('x 坐标');
    posFolder.add(sphere.position, 'y').min(-20).max(20).step(0.1).name('y 坐标');
    posFolder.add(sphere.position, 'z').min(-20).max(20).step(0.1).name('z 坐标');
    ...
    positionFolder.add(pointLight.position, 'x').min(-45).max(45).step(1).name('x 坐标');
    positionFolder.add(pointLight.position, 'y').min(-45).max(45).step(1).name('y 坐标');
    positionFolder.add(pointLight.position, 'z').min(-45).max(45).step(1).name('z 坐标');
